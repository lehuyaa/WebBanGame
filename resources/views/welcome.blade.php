        ...
        <div class="nk-carousel-inner">
            ...
            <div><div class="pl-5 pr-5">
                <div class="nk-product-cat-3">
                    <a class="nk-product-image" href="{{URL::to('/chi-tiet-san-pham/'.$random->Book_id)}}">
                        <img src="{{asset('public/uploadimage/'.$random->Book_image)}}" height="350" width="200" alt="" />
                    </a>
                    <div class="nk-product-cont">
                        <div class="nk-gap-1"></div>
                        <h3 class="nk-product-title h5"><a href="{{URL::to('/chi-tiet-san-pham/'.$random->Book_id)}}">{{$random->Book_name}}</a></h3>
                        <div class="nk-gap-1"></div>
                        <div class="nk-product-price">{{number_format($random->Book_price).' '.'VNĐ'}}</div>
                    </div>
                </div>
            </div></div>
            @endforeach    
    ...
    <div class="row vertical-gap">
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="{{URL::to('/chi-tiet-san-pham/'.$newgame->Book_id)}}">
                    <img src="{{asset('public/uploadimage/'.$newgame->Book_image)}}" height="350" width="200" alt="" />
                </a>
                <div class="nk-product-cont">
                    <h3 class="nk-product-title h5"><a href="{{URL::to('/chi-tiet-san-pham/'.$newgame->Book_id)}}">{{$newgame->Book_name}}</a></h3>
                    <div class="nk-gap-1"></div>
                    ...
                    <div class="nk-gap-1"></div>
                    {{$newgame->Book_content}}
                    <div class="nk-gap-2"></div>
                    <div class="nk-product-price">{{number_format($newgame->Book_price).' '.'VNĐ'}}</div>
                    <div class="nk-gap-1"></div>
    ...
    <div class="row vertical-gap">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="nk-product-cat">
                <a class="nk-product-image" href="{{URL::to('/chi-tiet-san-pham/'.$pricegame->Book_id)}}">
                    <img src="{{asset('public/uploadimage/'.$pricegame->Book_image)}}" height="350" width="200" alt="" />
                </a>
                <div class="nk-product-cont">
                    <h3 class="nk-product-title h5"><a href="{{URL::to('/chi-tiet-san-pham/'.$pricegame->Book_id)}}">{{$pricegame->Book_name}}</a></h3>
                    <div class="nk-gap-1"></div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form action="{{URL::to('/search-game')}}" class="nk-form nk-form-style-1" method="POST">
                    ...
                    <input type="submit" style="margin-top: 0 ; color: #000" name="search_book" class="btn btn-danger" value="Tìm Kiếm">
                </form>
            </div>
        </div>
    </div>
